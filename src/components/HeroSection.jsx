      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-3">
            {/* Primary */}
            <button
              className="cursor-pointer px-7 py-3 font-semibold rounded-xl shadow-md transition"
            ...
            {/* Secondary */}
            <button
              className="cursor-pointer flex items-center gap-2 px-7 py-3 rounded-xl font-semibold transition"
          ...
          <div className="flex items-center gap-6 ">
            ...
            {brands.map((src, idx) => (
              ...
              src={src}
              alt="brand"
              className="h-20  dark:invert dark:opacity-90"
              />
            ))}
          </div>
            {/* Trusted Line */}
